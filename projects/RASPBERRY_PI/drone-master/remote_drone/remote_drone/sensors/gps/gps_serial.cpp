...
void gps_serial::serial_init(void)
{
...
void gps_serial::serial_config(void)
{
...
void gps_serial::serial_println(const char *line, int len)
{
	if (uart0_filestream != -1) {
...
void gps_serial::serial_readln(char *buffer, int len)
{
	char c;
	char *b = buffer;
	int rx_length = -1;
...
void gps_serial::serial_close(void)
{
